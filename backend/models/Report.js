...
const reportSchema = new mongoose.Schema({
  content_type: { type: String, enum: ['note', 'comment', 'qa_question', 'qa_answer', 'college_question', 'college_answer', 'user', 'mentor', 'mentor_booking', 'forum_thread', 'forum_reply', 'resume', 'cover_letter', 'placement_qa_question', 'placement_qa_answer', 'placement_qa_comment', 'referrer_profile', 'classroom', 'classroom_host', 'study_group', 'group_member', 'group_message'], required: true },
