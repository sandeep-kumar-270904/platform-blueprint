...
const backendPath = 'C:/Users/edhub/Desktop/Anti Gravity Projects/platform-blueprint/backend';
dotenv.config({ path: path.join(backendPath, '.env') });

const User = require(path.join(backendPath, 'models/User'));
const Quiz = require(path.join(backendPath, 'models/Quiz'));
const QuizReport = require(path.join(backendPath, 'models/QuizReport'));
const LiveSession = require(path.join(backendPath, 'models/LiveSession'));
const QuizAttempt = require(path.join(backendPath, 'models/QuizAttempt'));
const Notification = require(path.join(backendPath, 'models/Notification'));
const notificationService = require(path.join(backendPath, 'services/notificationService'));
const cronService = require(path.join(backendPath, 'services/cronService'));
const quizScoringService = require(path.join(backendPath, 'services/quizScoringService'));
